            ...
            <div className="help-container">
                ...
                <div className="body">
                    ...
                    <ul>
                        ...
                        <br></br>
                        <li><em className="green">Green</em> signafies a correct letter in a correct position, or correct name length.</li>
                        <br></br>
                    ...
                    <br></br>
                    <ul>
                     <li>Any spaces, dashes, apostrophes, periods or accents have been removed.</li>
                     <br></br> 
                     <li>Numbers are spelled out (i.e. PORYGONTWO).</li>
                     <br></br>
                     <li>The male and female symbols have been replaces with M and F respectively for the Nidorans.</li>
                     </ul>
                </div>
            </div>
        </div>
